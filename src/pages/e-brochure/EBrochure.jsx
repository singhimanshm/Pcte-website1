...
const EBrochure = () => {
    ...
    return (
        <div className="bg-white min-h-screen font-sans">
            {/* Dark Hero Section */}
            <section className="bg-[#1a1c23] py-8 md:py-20 text-center">
                <div className="container mx-auto px-4">
                    <h6 className="text-white text-2xl md:text-2xl font-bold tracking-tight">
                        E-Brochure
                    </h6>
                </div>
            </section>
            ...
            <nav className="border-b border-gray-100 bg-white">
                <div className="container mx-auto px-4 py-3 text-sm text-gray-500">
                    <div className="flex items-center space-x-2">
                        ...
                        <span>›</span>
                        <span className="text-gray-400">E-Brochure</span>
                    </div>
                </div>
            </nav>
